...
class TestOllamaComplete:
    ...
    @patch("worker.models.providers.ollama.httpx.post")
    def test_no_system_message_when_empty(self, mock_post, provider: OllamaProvider) -> None:
    ...
    @patch("worker.models.providers.ollama.httpx.post")
    def test_tools_in_payload_when_provided(self, mock_post, provider: OllamaProvider) -> None:
        mock_post.return_value = _mock_response({"message": {"content": "ok"}})
