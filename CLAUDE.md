...
**YOU ARE IN: `filednotes/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/filednotes/` (rig root) or other directories
...
**Your mail address:** `filednotes/polecats/obsidian`
**Your rig:** filednotes
**Your Witness:** `filednotes/witness`
...
| Ask Witness for help | `gt mail send filednotes/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`filednotes/witness`) when:
...
```bash
gt mail send filednotes/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
